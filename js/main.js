...
const originalData = {
  ...
  pokemon: [
    ...
    {name: 'Pikachu (Party Hat)', owned: false, dex: '25', shiny: true,  shinyOwned: false, alolan: false, alolanOwned: false},
    {name: 'Raichu (Party Hat)', owned: false, dex: '26', shiny: true,  shinyOwned: false, alolan: false, alolanOwned: false},
